...
function Project() {
  return (
    <div id="project" style={{ textAlign: "left", fontFamily: "PT Sans, sans-serif", fontWeight: "100", color: "#2F2A2A" }}>
      ...
      description="A sleek and modern portfolio website designed to showcase Devante's projects and skills. The site features a clean layout, intuitive navigation, and responsive design to ensure optimal viewing across devices. It includes sections for about, projects, experience, and contact information."
